...
export SRC_NAME=-vc140-mt-${MAJOR_VER}_${MINOR_VER}
export DEBUG_SRC_NAME=-vc140-mt-gd-${MAJOR_VER}_${MINOR_VER}
...
mkdir -p ${p}/src/nar/resources/aol/${AOL_WIN}/lib
cp -p ${SRC_LIB}/${p}${SRC_NAME}.lib ${p}/src/nar/resources/aol/${AOL_WIN}/lib/${p}-${VERSION}.lib
cp -p ${SRC_LIB}/${p}${SRC_NAME}.dll ${p}/src/nar/resources/aol/${AOL_WIN}/lib/
cp -p ${SRC_LIB}/${p}${DEBUG_SRC_NAME}.lib ${p}/src/nar/resources/aol/${AOL_WIN}/lib/${p}-${VERSION}d.lib
cp -p ${SRC_LIB}/${p}${DEBUG_SRC_NAME}.dll ${p}/src/nar/resources/aol/${AOL_WIN}/lib/
...
if [ -d ${SRC_LINUX_LIB} ]; then
    ...
    mkdir -p ${p}/src/nar/resources/aol/${AOL_LINUX}/lib 
    cp -p ${SRC_LINUX_LIB}/lib${p}.so ${p}/src/nar/resources/aol/${AOL_LINUX}/lib/lib${p}-${VERSION}.so
fi